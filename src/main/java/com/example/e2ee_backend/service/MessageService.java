...
public class MessageService {
    ...
    public List<MessageDTO> fetchMessages(String userId,String chatUserId,int noOfWeek){
        List<MessageDetail> messages = messageRepository.getMessages(userId,chatUserId,noOfWeek);
